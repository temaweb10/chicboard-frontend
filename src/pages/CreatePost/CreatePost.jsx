...
import SelectPodCategory from "../../components/Select/SelectPodCategory";
...
function CreatePost() {
  ...
  const setPodCategoryFunc = (podCategory) => {
    setSelectValues({ ...selectValues, podCategory });
  };
  const setDescPost = (descPost) => {
    setSelectValues({ ...selectValues, descPost });
  };
  ...
  }, [selectValues, inputValues, podCategory]);
      ...
      <div className={styles["create-post_body"]}>
        <div className={styles["create-post_parent"]}>
          <div className={styles["create-post_content"]}>
            <div className={styles["create-post-max"]}>
              {/*   <DropzoneAreaBase
              ...
              <div className={styles["create-post_category"]}>
                <div style={{ width: "100%" }}>
                  ...
                  <Select
                    ...
                    className={styles["select-category_1"]}
                    onChange={(e) =>
                      setSelectValues({
                        ...selectValues,
                ...
                <SelectPodCategory
                  ...
                  setCategory={setPodCategoryFunc}
                />
              </div>
              <CreatePostInputs
                podCategory={selectValues.podCategory}
                setInputsValue={setDescPost}
              />
              <TextField
                id="outlined-basic"
                label="Заголовок"
              ...
              <div>
                ...
                {imageList.map((url) => {
                  return (
                    <img src={url} style={{ width: "200px" }} key={v4()} />
                  );
                })}
              </div>
              <div>
                ...
                >
                  ...
                  <MenuItem value="14">Якутия </MenuItem>
                  <MenuItem value="15">
